...
export { default as PortalLoader } from "./components/loaders/Loader3";
...
export { default as ButtonGetStarted } from "./components/buttons/Button6";
export { default as CloseButton } from "./components/buttons/Button7";